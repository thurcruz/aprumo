...
import { Bot, Brain, CircleDollarSign, HeartPulse, Route, Settings, Sun, UserRound, UsersRound } from 'lucide-react'
...
const system = [
  ...
  { href: '/planos', label: 'Planos', icon: Route },
...
export default function Sidebar() {
  ...
  return <aside className="theme-dark glass fixed bottom-5 left-5 top-5 z-40 hidden w-[224px] flex-col overflow-hidden rounded-[28px] p-4 md:flex">
    <Link href="/hoje" className="mb-4 flex shrink-0 items-center gap-3 px-2 text-white no-underline"><span className="grid h-10 w-10 shrink-0 place-items-center"><img src="/APRUMO_ICONE_AMARELO_MONO.png" alt="" width={34} height={34}/></span><div><strong className="tracking-[.16em]">Aprumo</strong><p className="muted text-[10px]">EVOLUA TODO DIA</p></div></Link>
